...
@Composable
fun TransferForm(onSaveClick: () -> Unit) {
    ...
    if (showAccountSheet) {
        AccountBottomSheet(
            selectedAccount = if (selectedField == "from") from else to,
    ...
    Column(
        ...
        HorizontalDivider(
            color = if (date.isEmpty()) Color(0xFF3D3D3D) else Color(0xFFFFFFFF),
            thickness = 1.dp
        )
        ...
        HorizontalDivider(
            color = if (amount.isEmpty()) Color(0xFF3D3D3D) else Color(0xFFFFFFFF),
            thickness = 1.dp
        )
        ...
        HorizontalDivider(
            color = if (from.isEmpty()) Color(0xFF3D3D3D) else Color(0xFFFFFFFF),
            thickness = 1.dp
        )
        ...
        HorizontalDivider(
            color = if (to.isEmpty()) Color(0xFF3D3D3D) else Color(0xFFFFFFFF),
            thickness = 1.dp
        )
    }
        ...
        HorizontalDivider(
            color = if (note.isEmpty()) Color(0xFF3D3D3D) else Color(0xFFFFFFFF),
            thickness = 1.dp
        )
        ...
        HorizontalDivider(
            color = if (description.isEmpty()) Color(0xFF3D3D3D) else Color(0xFFFFFFFF),
            thickness = 1.dp
        )
