...
@Composable
fun IncomeForm(onSaveClick: () -> Unit) {
    ...
    Column(
        ...
        HorizontalDivider(
            color = if (amount.isEmpty()) Color(0xFF3D3D3D) else Color(0xFF4C9AFF),
            thickness = 1.dp
        )
        ...
        HorizontalDivider(
            color = if (category.isEmpty()) Color(0xFF3D3D3D) else Color(0xFF4C9AFF),
            thickness = 1.dp
        )
    }
        ...
        HorizontalDivider(
            color = if (account.isEmpty()) Color(0xFF3D3D3D) else Color(0xFF4C9AFF),
            thickness = 1.dp
        )
        ...
        HorizontalDivider(
            color = if (note.isEmpty()) Color(0xFF3D3D3D) else Color(0xFF4C9AFF),
            thickness = 1.dp
        )
        ...
        HorizontalDivider(
            color = if (description.isEmpty()) Color(0xFF3D3D3D) else Color(0xFF4C9AFF),
            thickness = 1.dp
        )
